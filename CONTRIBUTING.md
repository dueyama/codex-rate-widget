...
- Treat Codex `account/*` methods as unstable implementation interfaces. Decode defensively and preserve partial functionality.
- Label account totals and limits as official only when they came from Codex account methods.
- Do not read the local Codex thread database or scan project directories.
